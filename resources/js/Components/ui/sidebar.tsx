...
//             <div
//                 className={cn(
//                     "h-10 px-4 py-4 flex flex-row z-[100]  hidden  items-center justify-between bg-neutral-100 dark:bg-neutral-800 w-full"
//                 )}
//                 {...props}
//             >
...
const CustomDiv:React.FC<PropsWithChildren<{className:string}>> = ({children,className})=>{
